...
export function AiEngineerResumeGuidePage() {
  const config = AI_ENGINEER_RESUME_GUIDE;
    ...
    <main className="min-h-screen bg-white text-slate-900">
      <section className="border-b border-slate-200 bg-slate-50/50">
        <div className="page-prose-wide pb-10 pt-6 sm:pb-12 sm:pt-8">
          <SeoBreadcrumbs
            kind="guide"
            currentLabel="AI Engineer Resume Guide"
      ...
      <div className="page-prose space-y-10 py-10 sm:py-14">
        ...
        <section className="rounded-2xl border border-sky-100 bg-sky-50/50 p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm text-slate-700 sm:text-base">
            130+ keywords grouped by LLM integration, RAG, evals, tools, cloud platforms, and seniority — with
            placement strategy and ATS-optimized bullet examples.
          </p>
          <Link
            href={config.keywordsPath}
